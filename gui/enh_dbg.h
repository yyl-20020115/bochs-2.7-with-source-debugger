...
extern int AsmLine[MAX_ASM];
extern int GetSrcLineCount();
extern void DoSrcCalc();
extern void DoSrcListSelect(int index);
...
extern const char* BTxt[7];

extern int BtnLkup[7];
